...
var CsdlDuocAuth = class {
  ...
  constructor(opts) {
    ...
    this.proxyAgent = opts.proxyUrl ? new ProxyAgent(opts.proxyUrl) : void 0;
  }
...
var PrescriptionItemSchema = z.object({
  ma_thuoc: z.string().or(z.number()).optional().nullable().transform((val) => val !== void 0 && val !== null ? String(val) : void 0),
...
var PrescriptionSchema = z.object({
  ...
  chan_doan: z.union([z.string(), z.array(z.any())]).optional().nullable(),
...
var TransactionResponseSchema = z.object({
  transactionId: z.string().or(z.number()).transform((val) => String(val)),
...
var HttpClient = class {
  ...
  constructor(opts, auth) {
    ...
    this.auth = auth;
    this.proxyAgent = opts.proxyUrl ? new ProxyAgent2(opts.proxyUrl) : void 0;
  }
  setAuth(auth) {
    this.auth = auth;
  }
